		...
		template(v-for="sensor in cell")
			tr
				td(style="text-align:left;")
					a(:id="'graph_'+sensor.o.id+'_on'" class="graph_on" onclick="var sensor=this.id.substring(0,this.id.length-3);document.getElementById(sensor).style.display='';document.getElementById(sensor+'_on').style.display='none';document.getElementById(sensor+'_off').style.display=''; document.getElementById('images_'+sensor.substr(6)).innerHTML='<iframe src=\"https://grafana.aq.sensors.africa/d-solo/xYBAfRaik/sensors-africa-single-sensor-view?orgId=1&var-sensor_id=' + sensor.substring(6) + '&panelId=2\" width=\"290\" height=\"200\" frameborder=\"0\"></iframe><br /><iframe src=\"https://grafana.aq.sensors.africa/d-solo/xYBAfRaik/sensors-africa-single-sensor-view?orgId=1&var-sensor_id=' + sensor.substring(6) + '&panelId=4\" width=\"290\" height=\"200\" frameborder=\"0\"></iframe><br /><br />'; return false;" href='#' style='color:white; text-decoration: none;') (+)&nbsp;{{sensor.o.id}}
